...
//#region node_modules/.nitro/vite/services/ssr/assets/social-D5QMRJSl.js
/**
...
async function fetchSocialPosts() {
	const supabase = getSupabase();
	if (!supabase) return [];
	const { data, error } = await supabase.from("social_posts").select("*").order("scheduled_for", {
		ascending: true,
		nullsFirst: false
	}).limit(100);
...
//#endregion
export { saveSocialPost as a, fetchSocialPosts as i, checkIntegrationHealth as n, deleteSocialPost as r, CONNECTORS as t };
